 ...
 */
	public function testLoginRedirect() {
		...
		$this->Auth->request->addParams(Router::parse('/login'));
		$this->Auth->request->url = '/login';
 ...
 */
	public function testLogout() {
		$this->Auth->Session->write('Auth.User.id', '1');
		$this->Auth->Session->write('Auth.redirect', '//login');
 ...
 */
	public function testLoginWithRequestData() {
		...
		$request = new CakeRequest('/login', false);
 ...
 */
	public function testStatelessFollowedByStatefulAuth() {
		...
		$this->assertEquals('//login', $this->Controller->testUrl);
	}
