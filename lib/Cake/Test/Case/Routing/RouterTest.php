 ...
 */
	public function testUrlNormalization() {
		...
		$result = Router::normalize('//login/scope://foo');
		$this->assertEquals('//login/scope:/foo', $result);
